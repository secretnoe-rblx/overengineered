...
/** Backpack control */
export default class BlockChooserControl extends Control<BlockChooserDefinition> {
	...
	constructor(
		...
		this.selectedCategory = new Bindable<AbstractCategory | undefined>(undefined);
