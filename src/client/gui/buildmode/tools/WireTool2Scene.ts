...
import WireTool2 from "client/tools/WireTool2";

export type WireTool2SceneDefinition = GuiObject & {
	readonly Bottom: {
...
export default class WireTool2Scene extends Control<WireTool2SceneDefinition> {
	readonly tool;

	constructor(gui: WireTool2SceneDefinition, tool: WireTool2) {
		super(gui);
		this.tool = tool;
