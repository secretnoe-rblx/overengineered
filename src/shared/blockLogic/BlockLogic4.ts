...
export abstract class BlockLogic4<TDef extends BlockLogicBothDefinitions> extends Component {
...
export abstract class CalculatableBlockLogic<TDef extends BlockLogicBothDefinitions> extends BlockLogic4<TDef> {
