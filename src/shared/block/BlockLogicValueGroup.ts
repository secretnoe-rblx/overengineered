...
export class BlockLogicValueGroup {
	private constructor() {}

	/** @deprecated delete this */
	static group2<BLV extends Omit<BL<BLV>, "holderId">>(
		blocks: readonly Block<BLV>[],
		...
		const calculateOrder = (values: readonly B[]): B[][] => {
			const calc = (numbers: Map<B, number>, value: B, index = 0) => {
	...
	static group<BLV extends BL<BLV>>(values: readonly BLV[]): readonly (readonly { readonly id: string }[])[] {
		type B = Block<BLV>;
